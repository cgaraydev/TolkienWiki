...
val mapsList = listOf(
    MapData(
        ...
        thumbnailRes = R.drawable.angband_thumb
    ),
    MapData(
        id = "1",
        name = "Arda",
        ...
        thumbnailRes = R.drawable.arda_thumb
    ),
    MapData(
        id = "2",
        name = "Beleriand",
        ...
        thumbnailRes = R.drawable.beleriand_thumb
    ),
    MapData(
        id = "3",
        name = "Mapa de Thrór",
        ...
        thumbnailRes = R.drawable.erebor_thumb
    ),
    MapData(
        id = "4",
        ...
        thumbnailRes = R.drawable.map_politics_thumb
    ),
    MapData(
        id = "5",
        name = "Tierra Media",
        ...
        thumbnailRes = R.drawable.middle_earth_1_thumb
    ),
    MapData(
        id = "6",
        name = "Tierra Media",
        ...
        thumbnailRes = R.drawable.middle_earth_2_thumb
    ),
    MapData(
        id = "7",
        name = "Tierra Media",
        ...
        thumbnailRes = R.drawable.middle_earth_3_thumb
    ),
    MapData(
        id = "8",
        name = "Tierra Media",
        ...
        thumbnailRes = R.drawable.middle_earth_4_thumb
    ),
    MapData(
        id = "9",
        name = "Mordor",
        ...
        thumbnailRes = R.drawable.mordor_thumb
    ),
    MapData(
        id = "10",
        name = "Númenor",
        ...
        thumbnailRes = R.drawable.numenor_thumb
    ),
    MapData(
        id = "11",
        name = "La Comarca",
        ...
        thumbnailRes = R.drawable.the_shire_1_thumb
    ),
    MapData(
        id = "12",
        name = "La Comarca",
        ...
        thumbnailRes = R.drawable.the_shire_2_thumb
    )
)